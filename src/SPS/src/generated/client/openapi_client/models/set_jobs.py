...
class SetJobs(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetJobs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetJobs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "jobId": obj.get("jobId"),
            "name": obj.get("name"),
            "nextJobId": obj.get("nextJobId"),
            "nextDeviceIp": obj.get("nextDeviceIp")
        })
        return _obj
